...
.PHONY: docker-build
docker-build:
	 docker build -t salvationdao/xsyn-transactions:develop -f ./DockerfileXsynTransactions .
	 docker build -t salvationdao/xsyn-transactions-migrate:develop -f ./DockerfileMigrate .
